...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"hhug","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 21 */
/*!**************************************!*\
  !*** D:/微信小程序项目/HB/hhug/api/home.js ***!
  \**************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.getFloors = exports.getNavList = exports.getBanners = void 0;var _request = _interopRequireDefault(__webpack_require__(/*! @/utils/request.js */ 22));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}

var getBanners = function getBanners() {return _request.default.get('/home/swiperdata');};
// 
exports.getBanners = getBanners;var getNavList = function getNavList() {return _request.default.get('/home/catitems');};exports.getNavList = getNavList;
var getFloors = function getFloors() {return _request.default.get('/home/floordata');};exports.getFloors = getFloors;

/***/ }),
/* 22 */
/*!*******************************************!*\
  !*** D:/微信小程序项目/HB/hhug/utils/request.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 24 */
/*!*****************************************!*\
  !*** D:/微信小程序项目/HB/hhug/utils/toast.js ***!
  \*****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0; // 普通提示
function toast(title) {var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;
  uni.showToast({
    title: title,
    icon: "none",
    duration: duration });
...
// 失败提示
toast.err = function toast(title) {var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;
  uni.showToast({
    title: title,
    icon: "error",
    duration: duration });
...
// 成功提示
toast.succcess = function toast(title) {var duration = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 3000;
  uni.showToast({
    title: title,
    icon: "succcess",
    duration: duration });
